...
R_HOME_DIR=/opt/homebrew/Cellar/r/4.5.2_1/lib/R
if test "${R_HOME_DIR}" = "/opt/homebrew/Cellar/r/4.5.2_1/lib/R"; then
   case "darwin25.0.0" in
   linux*)
     run_arch=`uname -m`
     case "$run_arch" in
     ...
     if [ -x "/opt/homebrew/Cellar/r/4.5.2_1/${libnn}/R/bin/exec/R" ]; then
        R_HOME_DIR="/opt/homebrew/Cellar/r/4.5.2_1/${libnn}/R"
     elif [ -x "/opt/homebrew/Cellar/r/4.5.2_1/${libnn_fallback}/R/bin/exec/R" ]; then
        R_HOME_DIR="/opt/homebrew/Cellar/r/4.5.2_1/${libnn_fallback}/R"
...
R_HOME="${R_HOME_DIR}"
export R_HOME
R_SHARE_DIR=/opt/homebrew/Cellar/r/4.5.2_1/lib/R/share
export R_SHARE_DIR
R_INCLUDE_DIR=/opt/homebrew/Cellar/r/4.5.2_1/lib/R/include
export R_INCLUDE_DIR
R_DOC_DIR=/opt/homebrew/Cellar/r/4.5.2_1/lib/R/doc
export R_DOC_DIR
